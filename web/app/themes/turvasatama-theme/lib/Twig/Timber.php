...
class Timber {
	...
	public function register_namespaces( $loader ) {
		...
		$loader->addPath( get_template_directory() . '/views/sections', 'sections' );
		$loader->addPath( get_template_directory() . '/views/layouts', 'layouts' );
		$loader->addPath( get_template_directory() . '/dist/images', 'icons' );
